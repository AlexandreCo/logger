...
class Database:
    ...
    def insert_new_host_value(self,id,primary_name,host_type,first_activity,last_activity,last_time_reachable,value, timestamp=None):
    ...
    def update_host_value(self,host_id,last_activity,last_time_reachable, timestamp=None):
        if timestamp is None:
            current_datetime = int(datetime.timestamp(datetime.now()))
        else :
            current_datetime=timestamp
    ...
    def add_data(self,device_id,primary_name,host_type,first_activity,last_activity,last_time_reachable,value, timestamp=None):
        ...
        if not ret:
            self.insert_new_host_value(device_id, primary_name, host_type, first_activity, last_activity,
                                     last_time_reachable, value,timestamp)
            #print("new :",primary_name,datetime.fromtimestamp(timestamp),value)
        else :
            host_id,state = ret
            if state != value:
                self.insert_new_host_value(device_id, primary_name, host_type, first_activity, last_activity,
                                         last_time_reachable, value,timestamp)
                #print("ins :", primary_name, datetime.fromtimestamp(timestamp),value)
            else :
                self.update_host_value(host_id, last_activity, last_time_reachable,timestamp)
                #print("upd :", primary_name, datetime.fromtimestamp(timestamp),value)
